...
**Version 7.0.3** -- Patch release: search indexing fixes for structured checkpoints, brief-linked recall, and deterministic BM25 ordering. See CHANGELOG.md for details.
