...
**Version 7.0.2** -- Patch release: reviewed defect fixes for checkpoint persistence, cross-workspace recall, and write-path workspace guards. See CHANGELOG.md for details.
