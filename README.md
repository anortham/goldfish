...
**Version 8.0.2** -- Fixes the Codex SessionStart JSON envelope and Cursor plugin root resolution; adds Antigravity setup and markdown-database interoperability guidance. See CHANGELOG.md for details.
